...
(function () {
  ...
  var COUNTRIES = [
    ...
    { f: "🇨🇳", fr: "Chine", ar: "الصين", v: [
      ...
      ["Visa sticker — renouvellement", "فيزا ملصق - تجديد", "8000", "7 jours ouvrables (présence du client le jour du dépôt)", "7 أيام عمل (الزبون يحضر يوم الإيداع)", CN_DOCS2, CN_COND2, CN_EXTRA2]
    ]},
