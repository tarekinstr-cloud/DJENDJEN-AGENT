...
(function () {
  ...
  document.querySelectorAll(".request-form [required]").forEach(function (control) {
  ...
  function fieldLabel(field, lang) {
    ...
    var c = field.querySelector("input, select");
  ...
  function buildMessage(form, lang) {
    ...
    form.querySelectorAll(".field").forEach(function (field) {
      ...
      if (!val) return;
      lines.push("• " + fieldLabel(field, lang) + ": " + val);
    });
  ...
  document.querySelectorAll(".wa-send").forEach(function (btn) {
    btn.addEventListener("click", function () {
      ...
      if (!validate(form)) {
        ...
        var bad = form.querySelector(".field--error input, .field--error select");
        if (bad) bad.focus();
        return;
      }
